...
[![Tests](https://img.shields.io/badge/tests-14%2F14%20passing-brightgreen.svg)](#testing)
[![Security](https://img.shields.io/badge/security-enhanced-green.svg)](#security-enhancements)

**Enhanced Python 3 Edition - Is your printer secure? Check before someone else does...**
...
- **🐍 Full Python 3 Compatibility** - Converted from Python 2 with modern syntax
- **🔒 Security Enhancements** - Fixed 19 eval(input()) vulnerabilities, added input validation
- **🚀 Performance Improvements** - Better buffer management, enhanced error handling
- **🎨 Enhanced User Experience** - Progress indicators, comprehensive help system
- **🧪 Automated Testing** - Complete test suite with 14 test cases
- **📚 Better Documentation** - Enhanced help, troubleshooting guides, and examples

See [ENHANCEMENTS.md](ENHANCEMENTS.md) for detailed information about all improvements.
...
# Example: Connect to printer with PostScript
python3 pret.py 192.168.1.100 ps

# Run with debug output
python3 pret.py 192.168.1.100 pjl --debug

# Load commands from file
python3 pret.py 192.168.1.100 ps --load commands.pret
```
...
Expected output: `📊 Test Results: 14/14 tests passed 🎉`

### Installation

PRET requires a Python 3.6+ interpreter. This enhanced version includes security improvements, performance optimizations, and better error handling.
...
- **Fixed Code Injection Vulnerabilities** - Replaced 19 dangerous `eval(input())` calls
...
- **Secure File Operations** - Safe filename handling and path validation

## ⚠️ Responsible Disclosure

PRET is designed for authorized security testing only. Always ensure you have proper authorization before testing any printer or network device. Unauthorized access to computer systems is illegal.
...
- **Documentation**: Check [ENHANCEMENTS.md](ENHANCEMENTS.md) for detailed information
- **Issues**: Report bugs and request features via GitHub Issues
- **Security**: For security-related issues, please use responsible disclosure
- **Original Research**: [Hacking Printers Wiki](http://hacking-printers.net/wiki/)
...
- Original PRET development by Jens Müller at Ruhr University Bochum
- Python 3 conversion and enhancements by the community
- All contributors who helped improve the security and functionality
